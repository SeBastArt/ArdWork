...
static unsigned int const NIXIE_MODULE_DRIVER_PATTERN_TIME_SOURCE = NIXIE_MODULE_DRIVER_TYPE + 2;
static unsigned int const NIXIE_MODULE_DRIVER_PATTERN_TIME_FORMAT = NIXIE_MODULE_DRIVER_TYPE + 3;
static unsigned int const NIXIE_MODULE_DRIVER_PATTERN_DATE_TIME = NIXIE_MODULE_DRIVER_TYPE + 4;
static unsigned int const NIXIE_MODULE_DRIVER_PATTERN_COLOR = NIXIE_MODULE_DRIVER_TYPE + 5;
