...
static unsigned int const MODULE_DRIVER_SET_DEBUG_OFF = MODULE_DRIVER_FIRST_MESSAGE + 1;
static unsigned int const MODULE_DRIVER_SET_DEBUG_ON = MODULE_DRIVER_FIRST_MESSAGE + 2;
