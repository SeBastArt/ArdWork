...
static unsigned int const Uart_GRBW_Led_Device_Driver_LAST_MESSAGE = UART_GRBW_LED_DEVICE_BRIGHTNESS;
...
static unsigned int const UART_GRBW_LED_SET_AUTO_BRIGHTNESS_EXTERN = UART_GRBW_LED_DEVICE_TYPE + 82;
static unsigned int const UART_GRBW_LED_SET_BRIGHTNESS_EXTERN = UART_GRBW_LED_DEVICE_TYPE + 83;
