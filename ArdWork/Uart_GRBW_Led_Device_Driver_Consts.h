...
static unsigned int const UART_GRBW_LED_COLOR_HEX = UART_GRBW_LED_DEVICE_TYPE + 10;
static unsigned int const UART_GRBW_LED_PATTERN = UART_GRBW_LED_DEVICE_TYPE + 11;
