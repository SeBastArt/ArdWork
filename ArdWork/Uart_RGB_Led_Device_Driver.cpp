...
void Uart_RGB_Led_Device_Driver::Exec_Animation_Color(uint8_t R, uint8_t G, uint8_t B)
{
...
void Uart_RGB_Led_Device_Driver::Exec_Set_Brightness(uint8_t _brightness)
{
