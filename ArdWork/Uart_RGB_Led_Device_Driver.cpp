...
int Uart_RGB_Led_Device_Driver::pixelCount;
...
{
	driver_name = "Uart_RGB_Led_Device_Driver";
...
void Uart_RGB_Led_Device_Driver::Build_Descriptor() {
	...
	Atomic<String> *atomic_pattern_cyclon = new Atomic<String>(RGB_ANIMATION_CYLON, "Cyclon");
	Atomic<String> *atomic_pattern_random = new Atomic<String>(RGB_ANIMATION_RANDOM, "Random");
	Atomic<String> *atomic_pattern_fire = new Atomic<String>(RGB_ANIMATION_FIRE, "Fire");
	Atomic<String> *atomic_pattern_shine = new Atomic<String>(RGB_ANIMATION_SHINE, "Shine");
	Atomic<String> *atomic_pattern_off = new Atomic<String>(RGB_ANIMATION_OFF, "Off");
	...
	Ctrl_Elem *ctrl_elem_auto_brightess = new Ctrl_Elem(UART_RGB_LED_SET_AUTO_BRIGHTNESS_EXTERN, "auto brightness mode", select, "choose if the brithness should be estimate automatically");
	...
	Ctrl_Elem *ctrl_elem_brightess = new Ctrl_Elem(UART_RGB_LED_SET_BRIGHTNESS_EXTERN, "brightness", edtvalue, "the brightness for the ambient light pattern");
	Atomic<int> *atomic_brightess = new Atomic<int>(0, &__brightness, "percent");
...
void Uart_RGB_Led_Device_Driver::DoAfterInit()
{
	SetRandomSeed();
...
void Uart_RGB_Led_Device_Driver::DoDeviceMessage(Int_Thread_Msg message)
{
	...
	case UART_RGB_LED_DEVICE_BRIGHTNESS:
	{
		if (__auto_brightness) {
			int brightness = message.GetIntParamByIndex(1);
	...
	break;
	case UART_RGB_LED_SET_AUTO_BRIGHTNESS_EXTERN:
	{
...
void Uart_RGB_Led_Device_Driver::SetBrightness(int _brightness) {
...
void Uart_RGB_Led_Device_Driver::Animation_Number(int _animation_number) {
...
void Uart_RGB_Led_Device_Driver::Animation_Color(int R, int G, int B)
{
...
{
	Int_Thread_Msg *message = new Int_Thread_Msg(UART_RGB_LED_DEVICE_BRIGHTNESS);
