...
static unsigned int const DEVICE_DRIVER_EXECUTE_COMMAND = DEVICE_DRIVER_FIRST_MESSAGE + 4;
static unsigned int const DEVICE_DRIVER_LAST_MESSAGE = DEVICE_DRIVER_EXECUTE_COMMAND;
