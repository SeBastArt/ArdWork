...
static unsigned int const LED_DEVICE_DRIVER_FIRST_MESSAGE = DEVICE_DRIVER_LAST_MESSAGE + 1000000;
static unsigned int const LED_DEVICE_DRIVER_PIN_HIGH = LED_DEVICE_DRIVER_FIRST_MESSAGE + 1;
static unsigned int const LED_DEVICE_DRIVER_PIN_LOW = LED_DEVICE_DRIVER_FIRST_MESSAGE + 2;
